    ...
    <div>
      ...
      <div className="mb-5 flex flex-wrap items-center gap-3">
        ...
        <div className="ml-auto">
          ...
          >
            <option value="all">Todos los status ({counts.all})</option>
            {STATUS_OPTIONS.map((s) => (
              <option key={s.value} value={s.value}>
                {STATUS_META[s.value].label} ({counts[s.value]})
              </option>
            ))}
          </select>
        </div>
              ...
              <tbody>
                {filtered.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-dark-gray/75 whitespace-nowrap tabular-nums">
                      {row.phone}
                    </td>
                    <td className="px-5 py-3.5">
