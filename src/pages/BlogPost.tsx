...
const BlogPost: React.FC = () => {
  ...
  const proseClassName = [
    ...
    // Tables — scrollable on narrow viewports so a wide table can't push the
    // page out and force horizontal scroll on the whole article.
    'prose-table:text-[15.5px] prose-table:my-8 prose-table:block prose-table:overflow-x-auto prose-table:w-full',
  ...
  return (
    <div className="min-h-screen bg-white text-dark-gray">
      ...
      <main>
        ...
        <section className="pt-28 md:pt-32 pb-8 md:pb-10">
          <div className="container mx-auto px-4">
            <div className="max-w-[720px] mx-auto">
              ...
              <h1 className="mt-6 text-[28px] sm:text-[32px] md:text-[48px] lg:text-[56px] font-poppins font-bold tracking-[-0.02em] sm:tracking-[-0.025em] leading-[1.1] sm:leading-[1.08] text-dark-gray break-words [hyphens:auto]">
                {post.title}
              </h1>
        ...
        {/* ── Body ── */}
        <section className="pb-16 md:pb-24 overflow-x-hidden">
          <div className="container mx-auto px-4">
